		...
		LOD 0
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					half4 appendResult47 = (half4(_ColorTexture.r , _ColorTexture.g , _ColorTexture.b , 0.0));
					half4 appendResult48 = (half4(i.color.r , i.color.g , i.color.b , 0.0));
					half4 appendResult18 = (half4(( appendResult47 * appendResult48 ).rgb , i.color.a));
					...
					half4 temp_cast_2 = (grayscale15).xxxx;
					half4 lerpResult16 = lerp( tex2DNode2 , temp_cast_2 , (( _GrayscaleOn )?( 1.0 ):( 0.0 )));
...
/*ASEBEGIN
Version=18900
1920;208;1360;707;1548.283;848.161;1.852813;True;False
...
Node;AmplifyShaderEditor.ColorNode;8;-867.5081,-390.9177;Inherit;False;Property;_ColorTexture;Color Texture;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-371.7465,-190.4127;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;18;-158.0759,-186.1225;Inherit;False;COLOR;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=F902B6877D42518FD2EF546E145D00737F35B157