	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 lerpResult19 = lerp( float4( 0,0,0,0 ) , lerpResult2 , lerpResult29);
...
/*ASEBEGIN
Version=18900
307;503;946;496;-523.5642;91.79536;1;True;False
...
Node;AmplifyShaderEditor.LerpOp;19;1200.915,-9.970921;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=F1B02D8D426ABC1E0AE5D3C44D7CD5A3DC7C6EFE